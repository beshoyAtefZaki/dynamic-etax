# Generated by Django 3.2.5 on 2024-12-28 11:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nowdate', models.DateTimeField(auto_created=True, auto_now=True, null=True)),
                ...
                ('refrence', models.CharField(blank=True, max_length=250, null=True)),
            ],
            options={
                'ordering': ['nowdate'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Desc_en', models.CharField(blank=True, max_length=250, null=True)),
                ('Desc_ar', models.CharField(blank=True, max_length=250, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='TaxSubtypes',
            fields=[
                ...
                ('Desc_en', models.CharField(blank=True, max_length=250, null=True)),
                ('Desc_ar', models.CharField(blank=True, max_length=250, null=True)),
                ('TaxtypeReference', models.CharField(blank=True, max_length=250, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Receiver',
            fields=[
                ...
                ('payer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='payer.payeraccount')),
            ],
        ),
    ]
